...
def build_validated_source(
    ...
    return {
        ...
        "query_family": candidate_result.get("query_family", ""),
        "source_family": candidate_result.get("source_family", ""),
...
def _build_warnings(
    ...
    warning_by_flag = {
        ...
        "secondary_guidance_only": "Verified informational source; official call should be preferred if available.",
        "known_untrusted_source": "Source was previously marked as untrusted.",
        "official_call_not_confirmed": "Official scholarship call link is not yet confirmed.",
    }
